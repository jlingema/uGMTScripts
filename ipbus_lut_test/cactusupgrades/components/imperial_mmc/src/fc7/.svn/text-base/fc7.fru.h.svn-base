...
static U8 gFRU_Info[] =
{
  ...
  0x0A,                   // Multi-Record Area Offset (Words)
  0x00,                   // Padding (00)
  0xEF,                   // Common Header Checksum
  ...
  // Product Info Area
  0x01,                   // Format Version
  0x05,                   // Product Area Length (Words)
  ...
  /* 53 */
  'M','P','7',              // Product Name
  0xC8,                    // Product Part Num
  'M','M','C',' ','v','1','.','2', // Product Part Num
  /* 61 */
...
#define FRU_PROD_LEN     43
#define FRU_PROD_CHKPOS  84
#define FRU_MRAR_START   89
#define FRU_MRAR_LEN     6
#define FRU_MRAR_CHKPOS  87
#define FRU_MRAH_START   84
#define FRU_MRAH_LEN     4
#define FRU_MRAH_CHKPOS  88
