...
-- START automatically  generated VHDL the Mon Apr  7 15:08:05 2014 
    if    std_match(addr, "----------------------------0---") then
      ...
      sel := ipbus_sel_t(to_unsigned(N_SLV_FREQ, IPBUS_SEL_WIDTH)); -- freq / base 0x00000008 / mask 0x0000000a
    elsif std_match(addr, "----------------------------1-1-") then
      sel := ipbus_sel_t(to_unsigned(N_SLV_HIST, IPBUS_SEL_WIDTH)); -- hist / base 0x0000000a / mask 0x0000000a
-- END automatically generated VHDL
